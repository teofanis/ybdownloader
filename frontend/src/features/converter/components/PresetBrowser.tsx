...
import { getCategoryLabel, getPresetName, getPresetDescription } from "../utils";
...
export function PresetBrowser({ presets, selectedPreset, onSelectPreset }: PresetBrowserProps) {
  ...
  return (
    <Card className="flex-1 overflow-hidden">
      <CardHeader className="pb-2">
        ...
        <CardDescription className="text-xs">{t("converter.presetsDescription")}</CardDescription>
      </CardHeader>
