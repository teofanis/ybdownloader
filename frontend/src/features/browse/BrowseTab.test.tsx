...
// Mock API
vi.mock('@/lib/api', () => ({
  searchYouTube: vi.fn(() => Promise.resolve({ results: mockSearchResults, query: 'test' })),
  getTrendingVideos: vi.fn(() => Promise.resolve({ results: mockSearchResults, query: 'trending' })),
...
describe('BrowseTab', () => {
  ...
  it('disables search button when input is empty', () => {
    renderWithProviders(<BrowseTab />);
    const searchButton = screen.getByRole('button', { name: /browse.openYoutube/i });
